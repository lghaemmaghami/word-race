...
assert(!dict.has('AMPERSAND'), 'AMPERSAND must not be a dictionary word')
assert(!dict.has('ASTERISK'), 'ASTERISK must not be a dictionary word')
assert(!dict.has('BACKSLASH'), 'BACKSLASH must not be a dictionary word')
assert(!dict.has('UNDERSCORE'), 'UNDERSCORE must not be a dictionary word')
assert(!dict.has('SEMICOLON'), 'SEMICOLON must not be a dictionary word')
assert(dict.has('PLUS'), 'PLUS must remain valid')
assert(dict.has('STAR'), 'STAR must remain valid')
